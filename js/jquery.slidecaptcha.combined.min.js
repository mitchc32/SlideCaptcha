...
!function(a){"use strict";if("undefined"==typeof a.fn.noUiSlider)throw"Required noUiSlider is not available.";var b=function(c,d){this.$el=a(c),this.opts=a.extend({},b.DEFAULTS,this.$el.data()),this.opts=a.extend({},this.opts,d),this.$el.empty().append('<p class="sc-instructions">'+this.opts.lockedText+"</p>").append('<div class="sc-slider-container"><div class="sc-slider"></div></div>').append('<div class="sc-status">'+this.opts.lockedTitle+"</div>").addClass("sc-locked");var e=this;this.$el.find(".sc-slider").noUiSlider({range:{min:0,max:10},start:0,connect:"lower"}).change(function(){var b=a(this),c=parseFloat(b.val());return c<5?e.lock():e.unlock()})};b.DEFAULTS={key:"_captcha",locked:!0,unlockUrl:"",unlockRequestType:"post",unlockParams:{},lockedClass:"sc-locked",lockedText:"This form is locked. Please drag or tap the slider below to unlock it.",lockedTitle:"Locked",unlockedClass:"sc-unlocked",unlockedText:"This form is unlocked!",unlockedTitle:"Unlocked",unlockingTitle:"Unlocking..."},b.prototype.unlock=function(){if(this.$el.find(".sc-slider").val(10),!this.opts.locked)return!0;var b=this;this.$el.children(".sc-status").html(this.opts.unlockingTitle),a.ajax(this.opts.unlockUrl,{data:this.opts.unlockParams,dataType:"json",method:this.opts.unlockRequestType}).success(function(a){return b.$el.append('<input type="hidden" name="'+b.opts.key+'" value="'+a[b.opts.key]+'" class="sc-val">'),b.$el.children(".sc-instructions").html(b.opts.unlockedText),b.$el.children(".sc-status").html(b.opts.unlockedTitle),b.$el.removeClass(b.opts.lockedClass).addClass(b.opts.unlockedClass),b.opts.locked=!1,!0}).error(function(){b.lock()})},b.prototype.lock=function(){return this.$el.find(".sc-slider").val("0"),this.$el.find(".sc-val").remove(),!!this.opts.locked||(this.$el.children(".sc-instructions").html(this.opts.lockedText),this.$el.children(".sc-status").html(this.opts.lockedTitle),this.$el.removeClass(this.opts.unlockedClass).addClass(this.opts.lockedClass),this.opts.locked=!0,!0)},b.prototype.isLocked=function(){return this.opts.locked},a.fn.slideCaptcha=function(c){return this.each(function(){var d=a(this),e=d.data("slidecaptcha"),f="object"==typeof c&&c?c:{};if(e||(e=new b(this,f),d.data("slidecaptcha",e)),"string"==typeof c){if("undefined"==typeof e[c])throw"The "+c+" does not exist";e[c]()}})},a.fn.slideCaptcha.isLocked=function(a){var b=a.data("slidecaptcha");return!b||b.opts.locked}}(jQuery);